...
{\textit{The thirty-eighth Woudschoten Conference in Zeist, The Netherlands}}
{\huuge SIAM Student Chapter at TU Delft}
{\underline{M. Baumann} \quad M. B. van Gijzen \hspace{6.3cm} October 2013}


\begin{pspicture}(0,0)(\contentswidth,\contentsheight)

\rput[tl](\leftcolspace,233mm){
  \posterroundedtabshadowbox{white}{\fbsdefault}{\leftcolwidth}{\large Application}{
    \small\raggedright
...
\rput[tl](\leftcolspace,189.5mm){
  \posterroundedtabshadowbox{white}{\fbsdefault}{\leftcolwidth}{\large The mathematical model}{
    \small\raggedright
